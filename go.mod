...
require github.com/urfave/cli/v2 v2.27.7 // indirect
...
// Force tablewriter to v0.0.5 for go-ethereum compatibility
//lint:file-ignore gomoddirectives Ignore linting on go.mod directives
replace github.com/olekukonko/tablewriter v1.0.6 => github.com/olekukonko/tablewriter v0.0.5

...
func (_EOStakeRegistry *EOStakeRegistryTransactor) UpdateOperatorsStake(opts *bind.TransactOpts, operators []common.Address, operatorIds [][32]byte, quorumNumber uint8) (*types.Transaction, error) {
	return _EOStakeRegistry.contract.Transact(opts, "updateOperatorsStake", operators, operatorIds, quorumNumber)
}

// UpdateOperatorsStake is a paid mutator transaction binding the contract method 0x6c3fb4bf.
//
// Solidity: function updateOperatorsStake(address[] operators, bytes32[] operatorIds, uint8 quorumNumber) returns(bool[])
func (_EOStakeRegistry *EOStakeRegistrySession) UpdateOperatorsStake(operators []common.Address, operatorIds [][32]byte, quorumNumber uint8) (*types.Transaction, error) {
	return _EOStakeRegistry.Contract.UpdateOperatorsStake(&_EOStakeRegistry.TransactOpts, operators, operatorIds, quorumNumber)
}

// UpdateOperatorsStake is a paid mutator transaction binding the contract method 0x6c3fb4bf.
//
// Solidity: function updateOperatorsStake(address[] operators, bytes32[] operatorIds, uint8 quorumNumber) returns(bool[])
func (_EOStakeRegistry *EOStakeRegistryTransactorSession) UpdateOperatorsStake(operators []common.Address, operatorIds [][32]byte, quorumNumber uint8) (*types.Transaction, error) {
	return _EOStakeRegistry.Contract.UpdateOperatorsStake(&_EOStakeRegistry.TransactOpts, operators, operatorIds, quorumNumber)
}

// UpdateOperatorsStake0 is a paid mutator transaction binding the contract method 0x7b0c1bb1.
//
// Solidity: function updateOperatorsStake(address[] operators, bytes32[] operatorIds, uint8 quorumNumber, uint32 operatorSetId) returns(bool[])
func (_EOStakeRegistry *EOStakeRegistryTransactor) UpdateOperatorsStake0(opts *bind.TransactOpts, operators []common.Address, operatorIds [][32]byte, quorumNumber uint8, operatorSetId uint32) (*types.Transaction, error) {
	return _EOStakeRegistry.contract.Transact(opts, "updateOperatorsStake0", operators, operatorIds, quorumNumber, operatorSetId)
}

// UpdateOperatorsStake0 is a paid mutator transaction binding the contract method 0x7b0c1bb1.
//
// Solidity: function updateOperatorsStake(address[] operators, bytes32[] operatorIds, uint8 quorumNumber, uint32 operatorSetId) returns(bool[])
func (_EOStakeRegistry *EOStakeRegistrySession) UpdateOperatorsStake0(operators []common.Address, operatorIds [][32]byte, quorumNumber uint8, operatorSetId uint32) (*types.Transaction, error) {
	return _EOStakeRegistry.Contract.UpdateOperatorsStake0(&_EOStakeRegistry.TransactOpts, operators, operatorIds, quorumNumber, operatorSetId)
}

// UpdateOperatorsStake0 is a paid mutator transaction binding the contract method 0x7b0c1bb1.
//
// Solidity: function updateOperatorsStake(address[] operators, bytes32[] operatorIds, uint8 quorumNumber, uint32 operatorSetId) returns(bool[])
func (_EOStakeRegistry *EOStakeRegistryTransactorSession) UpdateOperatorsStake0(operators []common.Address, operatorIds [][32]byte, quorumNumber uint8, operatorSetId uint32) (*types.Transaction, error) {
	return _EOStakeRegistry.Contract.UpdateOperatorsStake0(&_EOStakeRegistry.TransactOpts, operators, operatorIds, quorumNumber, operatorSetId)
}
